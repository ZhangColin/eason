...
//import com.eason.membership.account.AccountRepository;
...
//    }
//
//    public Account register(String username, String phone, String email, String realName) {
...
//
//        return new Account(idWorker.nextId(), username, phone, email, encodePassword, realName);
//    }
//
